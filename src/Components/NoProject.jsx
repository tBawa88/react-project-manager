...
export const NoProject = ({ onAddProject }) => {
    ...
    return (
        <div className='w-2/3 text-center mt-24'>
            ...
            <div>
                <button onClick={onAddProject} className='py-2 px-4 bg-stone-800 text-stone-300 rounded-md mt-2 hover:bg-stone-700 hover:text-stone-200'>
